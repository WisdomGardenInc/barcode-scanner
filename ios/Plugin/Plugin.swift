...
public class BarcodeScanner: CAPPlugin, AVCaptureMetadataOutputObjectsDelegate {
    ...
    private func discoverCaptureDevices() -> [AVCaptureDevice] {
        if #available(iOS 13.0, *) {
            ...
            return AVCaptureDevice.DiscoverySession(deviceTypes: [.builtInDualCamera, .builtInWideAngleCamera, .builtInTelephotoCamera], mediaType: .video, position: .unspecified).devices
        }
    }
